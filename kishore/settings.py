...
KISHORE_SOUNDCLOUD_VISUAL = getattr(settings, "KISHORE_SOUNDCLOUD_VISUAL", False)
KISHORE_SOUNDCLOUD_SHOW_ARTWORK = getattr(settings, "KISHORE_SOUNDCLOUD_SHOW_ARTWORK", False)
