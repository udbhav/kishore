...
from kishore.views import ProductDetail, ProductList, add_to_cart, cart, update_cart, remove_from_cart, checkout, shipping, shipping_methods, payment, process_payment, download, process_download
